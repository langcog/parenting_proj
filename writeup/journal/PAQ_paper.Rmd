---
title : "Measuring Implicit Theories of Parenting and Child Development"
...
keywords : "intuitive theories; parenting; attitude change"
wordcount : "X"
...
We next examined the loadings of individual items onto the three factors (Figure \ref{fig:loadings}). Items loaded onto the three factors in a way that was roughly consistent with our established subscales, but the factors did not pull apart completely. In particular, some items from the AA subscale loaded onto both the AA and EL factors, and several items from the EL subscale loaded more strongly onto the AA factor. Given the partial overlap of the EL and AA factors, it is possible that participants’ responses on these items were driven to some extent by a more general attitude towards more involved parenting. HIGHLIGHT PARTICULAR ITEMS.

MORE HERE ON THE DECISION TO MOVE FORWARD
