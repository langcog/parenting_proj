...
education_plot <- ggplot(filter(subinfo, !is.na(education)), aes(education))+
  geom_histogram(stat = "count") +
  xlab("Education") + 
  ylab("Count") +
  theme_base()+
...
Alpha for the whole scale was `r round(alpha_whole$total$raw_alpha, digits = 2)`, alpha for the AA subscale was `r round(alpha_aa$total$raw_alpha, digits = 2)`, alpha for the EL subscale was `r round(alpha_el$total$raw_alpha, digits = 2)`, and alpha for the RR subscale was `r round(alpha_rr$total$raw_alpha, digits = 2)`.
