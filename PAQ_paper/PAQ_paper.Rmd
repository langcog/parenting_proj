...
factors <- c("Intercept", "Child Development Articles", "AA PAQ score", "RR PAQ score", "EL PAQ score", "AA PAQ score * Child Development Articles", "RR PAQ score * Child Development Articles", "EL PAQ score * Child Development Articles")
...
We found that participants who agreed more strongly with EL attitudes were more likely to answer uptake questions correctly overall ($\beta$ = `r round(uptake$Estimate[5], digits = 2)`, 95% CI = `r round(uptake$l.95..CI[5], digits = 2)` - `r round(uptake$u.95..CI[5], digits = 2)`), but there was no interaction between EL scores and article type, meaning that there was no advantage for people with higher EL scores for understanding child development content in particular. However, unexpectedly, there was an interaction between AA attitudes and article type ($\beta$ = `r round(uptake$Estimate[6], digits = 2)`, 95% CI = `r round(uptake$l.95..CI[6], digits = 2)` - `r round(uptake$u.95..CI[6], digits = 2)`), such that people with stronger AA attitudes performed better on questions about child development articles compared to control articles. 
