...
subinfo$exclude_e1 <- subinfo$rt_exp1 < 15
                          
subinfo$exclude_e2 <- subinfo$rt_exp2 < 15

subinfo$exclude_c1 <- subinfo$rt_con1 < 15
  
subinfo$exclude_c2 <- subinfo$rt_con2 < 15
...
```{r eval = FALSE}
summary(glmer(acc ~ q_type * AA +  q_type * RR +
                (1|workerid) +
                (1|item), 
              data = d_an, 
              family = "binomial"))
