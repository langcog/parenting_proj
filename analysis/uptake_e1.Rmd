...
d$target_generalize_1 <- str_replace(d$target_generalize_1, "a","1")
d$target_generalize_1 <- str_replace(d$target_generalize_1, "b|c","0")
...
describe(subinfo$target_recall_1, skew=FALSE, check=FALSE)
describe(subinfo$target_recall_2, skew=FALSE, check=FALSE)
describe(subinfo$target_recall_3, skew=FALSE, check=FALSE)
describe(subinfo$target_recall_4, skew=FALSE, check=FALSE)
describe(subinfo$target_recall_5, skew=FALSE, check=FALSE)

describe(subinfo$target_generalize_1, skew=FALSE, check=FALSE)
describe(subinfo$target_generalize_2, skew=FALSE, check=FALSE)
describe(subinfo$target_generalize_3, skew=FALSE, check=FALSE)
describe(subinfo$target_generalize_4, skew=FALSE, check=FALSE)
describe(subinfo$target_generalize_5, skew=FALSE, check=FALSE)

describe(subinfo$control_recall_1, skew=FALSE, check=FALSE)
describe(subinfo$control_recall_2, skew=FALSE, check=FALSE)
describe(subinfo$control_recall_3, skew=FALSE, check=FALSE)
describe(subinfo$control_recall_4, skew=FALSE, check=FALSE)
describe(subinfo$control_recall_5, skew=FALSE, check=FALSE)

qplot(workerid, mean_target_recall, data=subinfo)
qplot(workerid, mean_control_recall, data=subinfo)
qplot(workerid, mean_target_generalize, data=subinfo)
qplot(workerid, reading_time_target, data=subinfo)
qplot(workerid, reading_time_control, data=subinfo)

qplot(workerid, target_recall_1, data=subinfo)
qplot(workerid, target_recall_2, data=subinfo)
qplot(workerid, target_recall_3, data=subinfo)
qplot(workerid, target_recall_4, data=subinfo)
qplot(workerid, target_recall_5, data=subinfo)

qplot(workerid, target_generalize_1, data=subinfo)
qplot(workerid, target_generalize_2, data=subinfo)
qplot(workerid, target_generalize_3, data=subinfo)
qplot(workerid, target_generalize_4, data=subinfo)
qplot(workerid, target_generalize_5, data=subinfo)

qplot(workerid, control_recall_1, data=subinfo)
qplot(workerid, control_recall_2, data=subinfo)
qplot(workerid, control_recall_3, data=subinfo)
qplot(workerid, control_recall_4, data=subinfo)
qplot(workerid, control_recall_5, data=subinfo)
